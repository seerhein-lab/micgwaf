...
/**
 * This class represents the HTML element with m:id warnMessage.
 ...
 **/
public class WarnMessage extends BaseWarnMessage implements Message
{
  /** Serial Version UID. */
  ...
  */
  public WarnMessage(String id, Component parent)
  {
    super(id, parent);
  }
