...
/**
 * This class represents the HTML element with m:id infoMessage.
 ...
 **/
public class InfoMessage extends BaseInfoMessage implements Message
{
  /** Serial Version UID. */
  ...
  */
  public InfoMessage(String id, Component parent)
  {
    super(id, parent);
  }
